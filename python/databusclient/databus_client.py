import databus_client_lib
import argparse_prompt


def direct_group_deploy(args):

    group = databus_client_lib.DataGroup(
        args.user,
        accountargs.group,
        args.title,
        args.title,
    ...
    databus_client_lib.deploy_to_dev_databus(args.apikey, group)
...
def generate_version(args):
    ...
    for uri in args.URIs:
        dbfiles.append(databus_client_lib.DatabusFile(uri, {}, "file"))

    version = databus_client_lib.DataVersion(
        args.user,
        args.group,
        args.artifact,
        args.version,
...
def direct_version_deploy(args):
    ...
    databus_client_lib.deploy_to_dev_databus(args.apikey, version)
